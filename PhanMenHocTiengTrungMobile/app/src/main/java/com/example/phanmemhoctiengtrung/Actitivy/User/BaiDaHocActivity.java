...
public class BaiDaHocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bai_da_hoc);
        setImages();
        lv_baidahoc = findViewById(R.id.lv_baidahoc);
        baiHocAdapter = new BaiHocAdapter(BaiDaHocActivity.this, Common.taiKhoan.getBaiDaHoc(), hinhAnhs);
